...
<div class="grid lg:grid-cols-3 gap-8 items-start mt-8">
            ...
            <div class="flex items-start justify-between gap-4 py-8">
                <div class="flex gap-6">
                    <div class="h-64 max-w-52 bg-gray-100 p-6 rounded">
                        <img src='https://drive.google.com/thumbnail?id=1hkHYvobBdZb5R9k_48zL3FWc2SEEnyIF' class="w-full h-full object-contain shrink-0" />
                    </div>
                    <div>
    ...
    <div class="">
        <div class="bg-gray-100 p-8 rounded-lg">
            <h3 class="text-2xl font-bold text-[#333]">Ringkasan Keranjang</h3>
