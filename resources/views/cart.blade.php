...
<div class="grid lg:grid-cols-3 gap-8 items-start mt-8">
    <div class="divide-y lg:col-span-2">
                ...
                <div>
                    ...
                    <div class="mt-6">
                        <button type="button" class="flex flex-wrap gap-2 text-xl text-[#333]">
                            <span class="bg-gray-100 px-2 py-1 rounded hover:bg-gray-200">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-3.5 fill-current"
                                    viewBox="0 0 124 124">
                                    <path
        ...
        <div class="flex items-start justify-between gap-4 py-8">
            <div class="flex gap-6">
                <div class="h-64 max-w-52 bg-gray-100 p-6 rounded">
                    <img src='https://readymadeui.com/product_img_2.webp'
                        class="w-full h-full object-contain shrink-0" />
                </div>
                <div>
                    <p class="text-md font-bold text-[#333]">Black T-Shirt</p>
    ...
    <div class="bg-gray-100 p-8 rounded-lg">
        ...
        <ul class="text-[#333] mt-6 divide-y">
            ...
            <li class="flex flex-wrap gap-4 text-md py-3">Tax <span class="ml-auto font-bold">$4.00</span>
            </li>
