...
<body>
    ...
    <div>
        <img src="6.jpg" class="w-full background-image: linear-gradient(0deg, rgba(0, 0, 0, .6), transparent 35%)"
            alt="">
    </div>
    <!-- End Hero -->
    ...
    <div class="bg-black">
        ...
        <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
            ...
            <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
                <h2 class="text-2xl font-bold md:text-4xl md:leading-tight text-white">Cocok untuk berbasgai macam jalan
                </h2>
                <p class="mt-1 text-gray-400">Ban Heavy duty untuk Komersial Truk</p>
            </div>
            <!-- End Title -->
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <a class="group rounded-xl p-5 transition-all hover:bg-white/[.05]" href="#">
                    <div class="aspect-w-16 aspect-h-10">
                        <img class="w-full object-cover rounded-xl"
                            src="https://awsimages.detik.net.id/community/media/visual/2023/05/08/10-km-jalan-kali-cbl-rusak-parah-dan-bahayakan-pengendara.jpeg?w=1200"
                ...
                <a class="group rounded-xl p-5 transition-all hover:bg-white/[.05]" href="#">
                    <div class="aspect-w-16 aspect-h-10">
                        <img class="w-full object-cover rounded-xl"
                            src="https://www.infosawit.com/wp-content/uploads/2022/10/Jalan-Kebun-Sawit.jpg"
                            alt="Image Description">
                    </div>
                    <h3 class="mt-5 text-xl text-gray-300 hover:text-white">
                        Jalan Perkebunan
                ...
                <a class="group rounded-xl p-5 transition-all hover:bg-white/[.05]" href="#">
                    <div class="aspect-w-16 aspect-h-10">
                        <img class="w-full object-cover rounded-xl"
                            src="https://www.mbcrusher.com/media/10593/w-639/h-359/Ambientazione_4.640x400.jpg"
                            alt="Image Description">
                    </div>
                    <h3 class="mt-5 text-xl text-gray-300 hover:text-white">
                        Area Pertambangan
    ...
    <div class="bg-black">
        <footer class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto bg-black">
            ...
            <div class="text-center">
                <div>
                    <a class="flex-none text-xl font-semibold text-white" href="#" aria-label="Brand">Golden Finger
                        Wheels Indonesia</a>
                </div>
                <!-- End Col -->
          ...
          <a class="inline-flex justify-center items-center size-10 text-center text-gray-500 hover:bg-gray-100 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-white transition dark:text-gray-500 dark:hover:text-gray-200 dark:hover:bg-gray-800" href="#">
            <img class="flex-shrink-0 size-3.5" src="https://e7.pngegg.com/pngimages/365/502/png-clipart-bridgestone-brand-logo-product-design-tire-bridgestone-logo-text-logo.png" alt="" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
          </a>
          <a class="inline-flex justify-center items-center size-10 text-center text-gray-500 hover:bg-gray-100 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-white transition dark:text-gray-500 dark:hover:text-gray-200 dark:hover:bg-gray-800" href="#">
            <img class="flex-shrink-0 size-3.5" src="https://e7.pngegg.com/pngimages/365/502/png-clipart-bridgestone-brand-logo-product-design-tire-bridgestone-logo-text-logo.png" alt="" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
          </a>
