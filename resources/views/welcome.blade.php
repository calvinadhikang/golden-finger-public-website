...
<body>
  ...
  <!-- Hero -->
    <div class="bg-black">
      <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-24 space-y-8">
        ...
        <div class="max-w-3xl text-center mx-auto">
          <p class="text-lg text-gray-400">Solusi Kebutuhan Ban Truck Anda</p>
        </div>
  ...
  <div>
    <img src="6.jpg" class="w-full background-image: linear-gradient(0deg, rgba(0, 0, 0, .6), transparent 35%)" alt="">
  </div>
  <!-- End Hero -->
  ...
  <div class="bg-black">
    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      ...
      <div class="w-2/3 sm:w-1/2 lg:w-1/3 mx-auto text-center mb-6">
        <h2 class="text-gray-400 ">Trusted by Open Source, enterprise, and more than 99,000 of you</h2>
      </div>
      <!-- End Title -->
  ...
  <div class="bg-black">
    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      ...
      <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
        <h2 class="text-2xl font-bold md:text-4xl md:leading-tight text-white">Customer stories</h2>
        <p class="mt-1 text-gray-400">See how game-changing companies are making the most of every engagement with Preline.</p>
      </div>
      <!-- End Title -->
      ...
      <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <!-- Card -->
        <a class="group rounded-xl p-5 transition-all hover:bg-white/[.05]" href="#">
          ...
          <h3 class="mt-5 text-xl text-gray-300 hover:text-white">
            Atlassian powers sales and support at scale with Preline.
          </h3>
          <p class="mt-3 inline-flex items-center gap-x-1 text-sm font-semibold text-gray-200">
            Learn more
  ...
  <div class="bg-black">
    <footer class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto bg-black">
      ...
      <div class="text-center">
        <div>
          <a class="flex-none text-xl font-semibold text-white" href="#" aria-label="Brand">Golden Finger Wheels Indonesia</a>
        </div>
        <!-- End Col -->

        <div class="mt-3">
          <p class="text-gray-500">Golden Finger Wheels <a class="font-semibold text-blue-600 hover:text-blue-700 dark:text-blue-500 dark:hover:text-blue-400" href="#">Indonesia</a></p>
          <p class="text-gray-500">© Preline. 2024 Htmlstream. All rights reserved.</p>
        </div>
