            ...
            <nav class="relative max-w-7xl w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8"
                ...
                <div id="navbar-collapse-with-animation"
                    ...
                    <div
                        ...
                        <a class="font-medium hover:text-slate-600 text-slate-500  sm:py-6" href="/" aria-current="page">Home</a>
            ...
            <div class="mx-auto max-w-screen-md py-12 px-4 sm:px-6 md:max-w-screen-xl md:py-20 lg:py-32 md:px-8 flex-1">
                <div class="md:pe-8 md:w-1/2 xl:pe-0 xl:w-5/12">
                    ...
                    <p class="mt-6 mb-6 text-base text-gray-500">
                        Bantu kami mengenal anda lebih dengan membuat akun. Isi formulir dibawah dan kembali berselancar di website kami.
                    </p>
                    <!-- End Title -->
                    ...
                    <form>
                        ...
                        <div class="grid">
                            <button type="submit"
                                class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">Buat Akun</button>
                        </div>
                        <div class="grid">
                            <p class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent  text-black">Sudah Punya Akun?
