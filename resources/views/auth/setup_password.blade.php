            ...
            <div class="mx-auto max-w-screen-md py-12 px-4 sm:px-6 md:max-w-screen-xl md:py-20 lg:py-32 md:px-8 flex-1">
                <div class="md:pe-8 md:w-1/2 xl:pe-0 xl:w-5/12">
                    ...
                    <h1 class="text-3xl text-gray-800 font-bold md:text-4xl md:leading-tight lg:text-5xl lg:leading-tight dark:text-gray-200">
                        <span class="text-blue-600">Buat</span> password untuk akun anda
                    </h1>
                    <p class="mt-6 mb-6 text-base text-gray-500">
                        Buat password yang hanya anda saja yang tau. Jangan pernah beri tau password anda kepada siapa-siapa termasuk <b>staff</b> kami.
                    </p>
                    <!-- End Title -->
                    ...
                    <form method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative">
                                ...
                                peer-[:not(:placeholder-shown)]:text-gray-500">Password Baru</label>
                            </div>
                            <!-- End Floating Input -->
                        </div>
                        <div class="mb-6">
                            ...
                            <div class="relative">
                                ...
                                peer-[:not(:placeholder-shown)]:text-xs
                                peer-[:not(:placeholder-shown)]:-translate-y-1.5
                                peer-[:not(:placeholder-shown)]:text-gray-500">Konfirmasi Password Baru</label>
                            </div>
                            <!-- End Floating Input -->
                        </div>
